...
const ConfirmRide = (props) => {
    ...
    const vehicleTitle = vehicleNames[vehicleKey] || 'Ride'
    ...
    return (
        <div className='p-2 sm:p-4'>
            ...
            <h3 className='text-xl sm:text-2xl font-semibold mb-3 text-center sm:text-left'>Confirm your {vehicleTitle}</h3>

            <div className='flex gap-2 justify-between flex-col items-center'>
                <div className='relative my-2'>
                    <img className='h-20 sm:h-24 object-contain' src={vehicleImg} alt={vehicleTitle} />
                </div>
                ...
                <button onClick={() => {
                    ...
                    props.setConfirmRidePanel(false)
                    props.createRide()
                }} className='w-full mt-4 bg-green-600 text-white font-semibold p-3 rounded-lg active:bg-green-700 shadow-sm text-base'>
                    Confirm Ride
                </button>
            </div>
        </div>
